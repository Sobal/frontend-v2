...
import twitterLogo from '@/assets/images/landing/thirdPartyLogos/twitter_logo_blue.svg';
...
<style scoped>
.background-image {
  background-image: url('/images/backgrounds/landing_footer_background.svg');
}
</style>